...
Defines the core data structures for representing test results, sessions, and outcomes in pytest-insight.
These models form the foundation for all analytics and insights in the system.
...
Insight Is Everything: These models are the raw material for all insights.
"""
