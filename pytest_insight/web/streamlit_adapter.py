...
from pytest_insight.web.visualization_core import DataProvider, VisualizationAdapter
...
class StreamlitAdapter(VisualizationAdapter):
    ...
    def render_stability_dashboard(self, sut: Optional[str] = None, days: int = 30) -> None:
        ...
        st.metric(
            ...
            delta=None if stability_data['trend'] == 'stable' else 
                  ("↑" if stability_data['trend'] == 'improving' else "↓")
        )
