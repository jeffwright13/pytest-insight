...
class TestReliabilityMetrics:
    ...
    def test_reliability_index_calculation(self):
        ...
        test1_attempt1 = TestResult(nodeid="test1", outcome=TestOutcome.FAILED)
        test1_attempt2 = TestResult(nodeid="test1", outcome=TestOutcome.PASSED)
        rerun_group1.add_test(test1_attempt1)
        rerun_group1.add_test(test1_attempt2)
        
        rerun_group2 = RerunTestGroup(nodeid="test2")
        test2_attempt1 = TestResult(nodeid="test2", outcome=TestOutcome.FAILED)
        test2_attempt2 = TestResult(nodeid="test2", outcome=TestOutcome.FAILED)
