...
def test_random_test_session(random_test_session):
    ...
    assert isinstance(
        random_test_session.sut_name, str
    ) and random_test_session.sut_name.startswith("SUT-")
    assert isinstance(
        random_test_session.session_id, str
    ) and random_test_session.session_id.startswith("session-")
    ...
    assert (
        random_test_session.session_stop_time > random_test_session.session_start_time
    )
